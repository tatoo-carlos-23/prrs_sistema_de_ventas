...
<div class="row">
    <div class="col-sm-4">
        <form id="frmVentasProductos">
            ...
            <!-- <input type="search" class="form-control input-sm" placeholder="Buscar..." aria-label="Search" id="clienteVenta" name="clienteVenta"> -->
            <select type="search" class="form-control input-sm" id="clienteVenta" name="clienteVenta">
            ...
            <select class="form-control input-sm" id="productoVenta" name="productoVenta">
                <option id="productoVenta" value="A">Seleccionar</option>
        ...
        $.ajax({
            ...
            success:function(r){
                ...
                if (r > 0) {
                    ...
                    Swal.fire('Venta creada con exito, consulte la informacion de esta en Ventas Realizadas','','success'); 

                }else if (r==0){
                    Swal.fire('No hay lista de venta !!','','warning');
                }else{
